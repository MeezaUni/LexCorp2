...
PREPROCESSOR_PATH = os.path.join(_BASE_DIR, "models", "preprocessor.joblib")
MODEL_PATH = os.path.join(_BASE_DIR, "models", "isolation_forest.joblib")
CONFIG_PATH = os.path.join(_BASE_DIR, "models", "model_config.json")
